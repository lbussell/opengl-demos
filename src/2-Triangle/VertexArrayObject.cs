...
internal sealed class VertexArrayObject<TVertexType> : IDisposable where TVertexType : unmanaged
{
    private readonly uint _handle;
    private readonly GL _openGl;

    public VertexArrayObject(GL openGl, BufferObject<TVertexType> vertexBuffer)
    {
