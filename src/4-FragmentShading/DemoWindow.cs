...
) : IOpenGLWindow
{
    ...
    /// <summary>
    /// Time in seconds since the window started rendering.
    /// </summary>
    private double _time;

    public static DemoWindow Create(GL gl, IWindow window)
    {
    ...
    public unsafe void Render(double deltaTime)
    {
        ...
        // _shader.SetUniform("u_time", (float)_time);
        _shader.SetUniform("u_resolution", _window.FramebufferSize);
